...
-- Quick save and quit (fixed conflicts)
keymap('n', '<leader>w', '<cmd>w<CR>', { desc = 'Save file' })
keymap('n', '<C-s>', '<cmd>w<CR>', { desc = 'Save file' })                     -- Added Ctrl+S
keymap('i', '<C-s>', '<Esc><cmd>w<CR>a', { desc = 'Save file (insert mode)' }) -- Ctrl+S in insert mode
...
-- Diagnostic keymaps (removed conflicts with LSP)
